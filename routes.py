...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(user.password, form.password.data):
            ...
            flash(f'Login Unsuccesful. Please check email and password!', 'error')
...
def update_post(post_id):
    ...
    return render_template('update.html',title='Update_Post', post=post, form=form)
